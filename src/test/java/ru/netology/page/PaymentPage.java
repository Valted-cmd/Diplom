...
import static ru.netology.page.Page.*;
...
public class PaymentPage {
    ...
    public void sendingValidData (Data.CardInfo info) {
    ...
    public void sendingNotValidData (Data.CardInfo info) {
        cardNumberField.setValue(info.getNumber());
        monthField.setValue(info.getMonth());
        yearField.setValue(info.getYear());
        ownerField.setValue(info.getHolder());
    ...
    public void sendingEmptyNameValidData (Data.CardInfo info) {
        cardNumberField.setValue(info.getNumber());
        monthField.setValue(info.getMonth());
        yearField.setValue(info.getYear());
        cvcField.setValue(info.getCvc());
